...
newDir="./jobs/${timestamp}_linprobe_entropy_base_IMNETMINI"
mkdir -p "$newDir"
...
blr=0.1
warmupEpochs=10
finetune="/home/ingo/Desktop/Code Stuff/mae/jobs/20240909204002_Pretrain_IMNET1K_epoch20_entropy_ratio75_warmup2_modelbase/outputs/checkpoint-19.pth"
dataPath="/media/ingo/imnet_data/imagenet-mini"
nbClasses=1000
